...
export class SignalModel {
  ...
  @Expose() forecast: string = '';
  @Expose() payout: string = '';
  @Expose() @Type(() => Date) timeentryDateTime?: Date | null = null;

  @Expose() winRat: string = '';
  @Expose() dojiHit: boolean = false;
...
function convertObjectDate(json: any) {
  ...
  json.timeentryDateTime = convertToDate(json.timeentryDateTime);
